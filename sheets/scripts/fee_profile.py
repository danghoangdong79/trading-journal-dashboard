...
def apply_fee_profile_formulas(ws_journal):
    ...
    ws_journal.update_acell("S1", r'''={"Biên Độ"; ARRAYFORMULA(IF(E2:E="", "", IF(P2:P="", "", IF(REGEXMATCH(UPPER(F2:F), "SHORT|BÁN|BAN"), O2:O-P2:P, P2:P-O2:O))))}''')
    ws_journal.update_acell("T1", get_gross_pnl_formula())
    ws_journal.update_acell("U1", get_fees_formula())
    ws_journal.update_acell("V1", r'''={"Lãi/Lỗ Ròng"; ARRAYFORMULA(IF(E2:E="", "", IF(P2:P="", "", T2:T - U2:U)))}''')
